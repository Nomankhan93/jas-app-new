...
const welcome = {
  en: {
    ...
    note: 'Account creation is the first step. Membership is confirmed after application review.',
  ...
  ur: {
    ...
    note: 'اکاؤنٹ بنانا پہلا قدم ہے۔ رکنیت کی تصدیق درخواست کے جائزے کے بعد ہوتی ہے۔',
  ...
  sd: {
    ...
    note: 'اڪائونٽ ٺاهڻ پهريون قدم آهي. ميمبرشپ جي تصديق درخواست جي جائزي کان پوءِ ٿيندي۔',
